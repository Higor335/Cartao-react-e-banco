...
const About: React.FC = () => {
  ...
  <div className="app_wrapper">
    ...
    <p>Na aba <Link to="/" className='links'>Listar</Link> é possível observar tais informações que estão dispostas em formato de cartão de visitas, contendo dados como o Nome, e-mail, endereço e telefone de cada pessoa.
